<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>验证码:</label>
        <input type="text" placeholder="请输入你的邮箱" v-model="code"
        name="code" v-validate="{required:true,regex:/^1\d{6}$/}" 
  ...
  export default {
    ...
    userRegister(){
      try{
        ...
        (phone&&password==password1&&code==this.code)&&this.$store.dispatch('userRegister',{phone,code,password})
