          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0" 
                v-for="(spuAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" 
                    :class="{active:spuAttrValue.isChecked==1}"
                @click="changeActive(spuAttrValue,spuSaleAttr.spuSaleAttrValueList)"
                :key="spuAttrValue.id">{{ spuAttrValue.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
...
import {  mapGetters } from 'vuex'
  ...
  export default {
    ...
    methods:{
      changeActive(spuAttrValue,spuSaleAttrValueList){
        //属性排它
     ...
     async addShopCar(){
        ...
        try{
          //成功
          let result=await this.$store.dispatch('addOrUpdateShopCar',
