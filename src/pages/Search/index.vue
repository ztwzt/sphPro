      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <!-- 属性值展示 -->
            <li class="with-x" v-for="(props,index) in searchParams.props" :key="props.attrId">{{props.split(":")[1]}}
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="(goods,index) in goodsList" :key="goods.id">
                <div class="list-wrap">
                  ...
                  <div class="attr">
                    <a target="_blank" href="item.html" title="促销信息，下单即赠送三个月CIBN视频会员卡！【小米电视新品4A 58 火爆预约中】">{{ goods.titel }}</a>
                  </div>
                  <div class="commit">
...
<script>
  ...
  export default {
   ...
   mounted(){
    ...
    computed:{
      //仓库中的getters是不分模块的 参数 params 数组
    ...
    methods:{
        ...
        removeCategoryName(){
          //删除categoryname，并再次发请求
          //参数可有可无，如果属性值为空则仍然带上该参数
          //undefined 则不带
          ...
          this.getData()
          //地址栏也要修改，进行路由跳转 删除query 参数需要注意params 严谨
